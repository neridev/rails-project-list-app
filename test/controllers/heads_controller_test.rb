...
class HeadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create head" do
    assert_difference("Head.count") do
      post heads_url, params: { head: { name: @head.name, notes: @head.notes, position: @head.position, surname: @head.surname, techlead: @head.techlead } }
    end
  ...
  test "should update head" do
    patch head_url(@head), params: { head: { name: @head.name, notes: @head.notes, position: @head.position, surname: @head.surname, techlead: @head.techlead } }
